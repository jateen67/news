...
with open("../../data/global_feed.json") as file1_data:
    file1_content = json.load(file1_data)

with open("../../data/global_article_content_cleaned.json") as file2_data:
...
with open("../../data/global_merged.json", "w") as outfile:
